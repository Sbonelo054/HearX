...
class HearXViewModel(private val application: Application) : AndroidViewModel(application) {
    ...
    var roundText = "Round: $numberOfRound"
    var arrayListDigits:List<Int> = listOf(R.raw.digit_1, R.raw.digit_2, R.raw.digit_3, R.raw.digit_4, R.raw.digit_5, R.raw.digit_6, R.raw.digit_7, R.raw.digit_8, R.raw.digit_9)
    var arrayListNoiseLevel: List<Int> = listOf(R.raw.noise_1, R.raw.noise_2, R.raw.noise_3, R.raw.noise_4, R.raw.noise_5, R.raw.noise_6, R.raw.noise_7, R.raw.noise_8, R.raw.noise_9, R.raw.noise_10)
    ...
    fun submit(bind: () -> FragmentTestBinding) {
